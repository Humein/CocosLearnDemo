    ...
    execute: function () {
      ...
      _export("item_pic_nodeEvent", item_pic_nodeEvent = (_dec = ccclass('item_pic_nodeEvent'), _dec(_class = (_class2 = class item_pic_nodeEvent extends Component {
        ...
        onTouchAllStart(event) {
          ...
          var transform = this.node.getComponent(UITransform);
          var nodePos = transform.convertToNodeSpaceAR(v3(uiPos.x, uiPos.y, 0)); // 定义边缘触发范围（假设为节点大小的一部分）

          var edgeThreshold = 80; // 可根据需要调整阈值
          // 检查触摸点是否在节点的边缘范围内
...
//# sourceMappingURL=bbcc68ef6f937ab113d62ac5b3b117b79beda532.js.map
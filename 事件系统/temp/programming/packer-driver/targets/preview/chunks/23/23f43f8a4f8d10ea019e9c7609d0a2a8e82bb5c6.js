        ...
        start() {
          ...
          this.buttonLeft.on(Node.EventType.TOUCH_END, () => {
            ...
            tween(color).to(2, {
              ...
              onUpdate: (target, ratio) => {// this.rLabelNode.color = new Color(color.x, color.y, color.z);
              }
            }).union().repeatForever().start(); // const obj = {
...
//# sourceMappingURL=23f43f8a4f8d10ea019e9c7609d0a2a8e82bb5c6.js.map
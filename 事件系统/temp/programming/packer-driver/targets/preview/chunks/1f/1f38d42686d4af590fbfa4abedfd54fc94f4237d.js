System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Color, Component, Label, Node, Sprite, tween, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, GameRoot;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Color', 'Component', 'Label', 'Node', 'Sprite', 'tween', 'v3']);
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        start() {
          ...
          var lSprite = this.buttonLeft.getComponent(Sprite);
          var rSprite = this.buttonLeft.getComponent(Sprite); // 将背景颜色应用到 cc.Sprite 组件的 Material
        ...
        myAnimation() {
          ...
          tween(obj).to(0.5, {
            ...
            onUpdate: (target, ratio) => {
              ...
              this.wxy.setPosition(this.wxy.position.y, obj.n); // 使用 => 使用箭头函数将 this 绑定到你的函数内
            },
            ...
            onUpdate: (target, ratio) => {
              ...
              this.wxy.setPosition(this.wxy.position.y, obj.n);
            },
...
//# sourceMappingURL=1f38d42686d4af590fbfa4abedfd54fc94f4237d.js.map
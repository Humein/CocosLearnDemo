    ...
    execute: function () {
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        start() {
          ...
          var sprite = this.buttonLeft.getComponent(Sprite); // 创建一个新的 cc.Color 对象，设置为你想要的背景颜色

          var bgColor = new Color(255, 0, 0); // 这里设置为红色
...
//# sourceMappingURL=136d7d5e0a775e3018c8317b39d0ac59bd8371f0.js.map
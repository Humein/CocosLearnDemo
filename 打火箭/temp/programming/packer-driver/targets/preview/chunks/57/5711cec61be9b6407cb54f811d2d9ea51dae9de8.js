System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, input, Input, KeyCode, Prefab, instantiate, Collider2D, Contact2DType, director, Director, tween, Label, Vec3, PhysicsSystem2D, Quat, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _crd, ccclass, property, PHY_GROUP, PHY_TAG, GameRoot;
    ...
    execute: function () {
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(Label), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        start() {
          ...
          this.openColloder2DEvent(); // director.preloadScene("pushBox", function () {
        ...
        initData() {
          ...
          tween(color).to(2, {
            ...
            onUpdate: (target, ratio) => {// this.scoreLabel.color = new Color(color.x, color.y, color.z);
            }
          }).to(2, {
            x: 120,
            y: 0,
        ...
        startCreateEggs() {
          ...
          this.schedule(() => {
            ...
            var targetX = 0;
            var targetY = 100; // 相对于初始UFO节点的Y坐标
        ...
        openColloder2DEvent() {
          ...
          console.log(collisionMatrix); // 获取 this.player 上的碰撞组件
          ...
          comp == null ? void 0 : comp.on(Contact2DType.BEGIN_CONTACT, (selfCollider, otherCollider, contact) => {
            // 获取碰撞对象的Tag
            var otherCTag = otherCollider.tag; // 根据标签区分碰撞对象
        ...
        onBeginContact(selfCollider, otherCollider, contact) {
          ...
          var otherCTag = otherCollider.tag;
        ...
        jumpDownAnimation(dir) {
          this.makeMoveStepIndex(dir);
          var targetX = window.innerHeight / this.hensPosXArr.length;
          var jumpX = dir === 1 ? targetX : -targetX;
        ...
        playJumpAndRollEffect(selfCollider) {
          var jumpHeight = 100; // 跳跃高度

          var jumpDuration = 0.5; // 跳跃持续时间

          var screenWidth = window.innerWidth; // 屏幕宽度，根据你的游戏设置

          var rotationDuration = 1.0; // 旋转持续时间
          // 标记为跳跃状态

          this.isJumping = true;
          var originalPosition = selfCollider.node.position;
          var henW = window.innerHeight / this.hensPosXArr.length;
          var jumpPosition = new Vec3(originalPosition.x - henW, originalPosition.y + jumpHeight, originalPosition.z); // 检查目标位置是否超出屏幕范围
        ...
        playFallEffect(selfCollider) {
          var fallDuration = 0.1; // 下落持续时间

          var originalPosition = selfCollider.node.position;
          var fallPosition = new Vec3(originalPosition.x, originalPosition.y - 100, originalPosition.z); // 使用 Tween 实现下落的效果
...
//# sourceMappingURL=5711cec61be9b6407cb54f811d2d9ea51dae9de8.js.map
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        startCreateEggs() {
          this.schedule(() => {
            ...
            egg.setPosition(this.hensPosXArr[Math.floor(Math.random() * this.hensPosXArr.length)], this.hensRoot.position.y, 0);
          }, 1);
        } // Event Handlers
...
//# sourceMappingURL=b1557aa7fba59a6c4e4ff2669dedc0170e86a3a4.js.map
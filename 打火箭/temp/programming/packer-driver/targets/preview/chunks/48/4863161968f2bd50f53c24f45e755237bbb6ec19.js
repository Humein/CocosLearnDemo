System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, input, Input, KeyCode, Prefab, instantiate, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, GameRoot;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'EventKeyboard', 'Node', 'input', 'Input', 'KeyCode', 'Prefab', 'instantiate']);
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec(_class = (_class2 = class GameRoot extends Component {
        constructor() {
          super(...arguments);
        ...
        initData() {
          for (var i = 0; i < this.hensRoot.children.length; i++) {
            var element = this.hensRoot.children[i]; // hens每个子元素的X坐标 就是player的移动范围
        ...
        startCreateEggs() {
          this.schedule(() => {
            ...
            egg.setPosition(this.hensPosXArr[Math.floor(Math.random() * this.hensPosXArr.length)], this.hensRoot.position.y + 200, 0);
          }, 1);
        } // Event Handlers
...
//# sourceMappingURL=4863161968f2bd50f53c24f45e755237bbb6ec19.js.map
System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, input, Input, KeyCode, Prefab, instantiate, Collider2D, Contact2DType, director, Director, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, GameRoot;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec(_class = (_class2 = class GameRoot extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "ufoHit", _descriptor6, this);
        ...
        startCreateEggs() {
          ...
          this.schedule(() => {
            ...
            var ufoHitWidth = 50; // ufoHit 的宽度

            var spacingBetweenUFOs = ufoHitWidth * 1; // 初始间距

            for (var i = 0; i < numberOfUFOs; i++) {
              var ufo = instantiate(this.ufoHit);
              this.ufoHitRoot.addChild(ufo); // 计算每个 ufoHit 的水平位置

              var targetX = i * spacingBetweenUFOs;
              var targetY = 0;
              ufo.setPosition(targetX, targetY, 0); // 根据上一个预制体是否排连在一起来调整间距

              if (i === 0) {
                spacingBetweenUFOs = ufoHitWidth * (Math.random() + 1); // 间距为 ufoHitWidth 到 ufoHitWidth * 2 之间
              } else {
                spacingBetweenUFOs = ufoHitWidth * (Math.random() + 2); // 间距为 ufoHitWidth*2 到 ufoHitWidth *3 之间
              }
            }
          }, 1);
        } // Init big bang
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "ufoHit", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=ef48353aa19b94f27b3347b0c8bc0f68a333f468.js.map
        ...
        startCreateEggs() {
          ...
          this.schedule(() => {
            ...
            for (var i = 0; i < numberOfUFOs; i++) {
              ...
              if (i === 0) {
                spacingBetweenUFOs = ufoHitWidth * (Math.random() + 2); // 间距为 ufoHitWidth 到 ufoHitWidth * 2 之间
              } else {
                spacingBetweenUFOs = ufoHitWidth * (Math.random() + 3); // 间距为 ufoHitWidth*2 到 ufoHitWidth *3 之间
              }
            }
          }, 1);
        } // Init big bang
...
//# sourceMappingURL=00ec82266ecfc13ddb2ffc00c8dbe18b3add64da.js.map
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        update(deltaTime) {
          ...
          for (var _i = 0; _i < this.ufoHitRoot.children.length; _i++) {
            console.log('this.ufoHitRoot.children.length', this.ufoHitRoot.children.length);
            ...
            _element.setPosition(_x, _y, 0); // if (x < -500) {
            //     element.destroy();
            // }
        ...
        startCreateEggs() {
          this.schedule(() => {
            ...
            var ufoHit = instantiate(this.ufoHit);
            ufoHit.setPosition(targetX, targetY, 0);
          }, 1); // 生产Car
...
//# sourceMappingURL=63c468636638a716b5d1fcf552523cd9019a69d9.js.map
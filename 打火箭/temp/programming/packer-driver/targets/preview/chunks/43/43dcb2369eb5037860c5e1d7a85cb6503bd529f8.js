      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(Label), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        startCreateEggs() {
          ...
          this.schedule(() => {
            ...
            var physicsSystem = PhysicsSystem2D.instance; // const collisionMatrix = physicsSystem.collisionMatrix;
            // 初始化碰撞矩阵

            var collisionMatrix = [];

            for (var i = 0; i < PHY_GROUP.BULLET_PROP; i++) {
              collisionMatrix[i] = [];

              for (var j = 0; j < PHY_GROUP.BULLET_PROP; j++) {
                collisionMatrix[i][j] = false;
              }
            } // 启用 PHY_GROUP.BULLET_PROP 与 PHY_GROUP.DEFAULT 之间的碰撞


            collisionMatrix[PHY_GROUP.BULLET_PROP][PHY_GROUP.DEFAULT] = true;
            collisionMatrix[PHY_GROUP.DEFAULT][PHY_GROUP.BULLET_PROP] = true; // 禁用其他碰撞，如果需要
            // collisionMatrix[PHY_GROUP.BULLET_PROP][PHY_GROUP.SOME_OTHER_GROUP] = false;
            // collisionMatrix[PHY_GROUP.SOME_OTHER_GROUP][PHY_GROUP.BULLET_PROP] = false;
...
//# sourceMappingURL=43dcb2369eb5037860c5e1d7a85cb6503bd529f8.js.map
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(Label), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        openColloder2DEvent() {
          var comp = this.player.getComponent(Collider2D); // comp?.on(Contact2DType.BEGIN_CONTACT, (selfCollider: Collider2D, otherCollider: Collider2D, contact: IPhysics2DContact | null) => {
          //     console.log('碰撞开始');
          //     this.playScore += 1;
          //     this.updateScore();
          //     // 在下一帧的物理模拟之后销毁物体
...
//# sourceMappingURL=ab3422e301cfadcfbb5c1a7eeb8baa730467ceae.js.map
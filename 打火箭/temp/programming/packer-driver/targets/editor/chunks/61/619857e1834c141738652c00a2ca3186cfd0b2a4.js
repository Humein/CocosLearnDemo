    ...
    execute: function () {
      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(Label), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        openColloder2DEvent() {
          ...
          playerCollider.group = PHY_GROUP.DEFAULT; // const eggsRoot = this.eggsRoot.getComponent(Collider2D);
          // eggsRoot.group = PHY_GROUP.DEFAULT  
          // const ufoHitRoot = this.ufoHitRoot.getComponent(Collider2D);
          // ufoHitRoot.group = PHY_GROUP.DEFAULT 
          // 处理碰撞逻辑
          ...
          comp == null ? void 0 : comp.on(Contact2DType.BEGIN_CONTACT, (selfCollider, otherCollider, contact) => {
            console.log('碰撞开始'); // 获取碰撞对象的碰撞组

            const selfGroup = selfCollider.group;
            const otherGroup = otherCollider.group; // 判断是否是player与eggsRoot的碰撞
...
//# sourceMappingURL=619857e1834c141738652c00a2ca3186cfd0b2a4.js.map
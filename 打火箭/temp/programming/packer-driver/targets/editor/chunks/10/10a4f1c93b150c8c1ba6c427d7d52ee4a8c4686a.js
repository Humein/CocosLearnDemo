      ...
      _export("GameRoot", GameRoot = (_dec = ccclass('GameRoot'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(Label), _dec(_class = (_class2 = class GameRoot extends Component {
        ...
        startCreateEggs() {
          ...
          this.schedule(() => {
            ...
            const physicsSystem = PhysicsSystem2D.instance; // const collisionMatrix = physicsSystem.collisionMatrix;
            // 初始化碰撞矩阵

            const collisionMatrix = [];

            for (let i = 0; i < PHY_GROUP.BULLET_PROP; i++) {
              collisionMatrix[i] = [];

              for (let j = 0; j < PHY_GROUP.BULLET_PROP; j++) {
...
//# sourceMappingURL=10a4f1c93b150c8c1ba6c427d7d52ee4a8c4686a.js.map
        ...
        startCreateEggs() {
          ...
          this.schedule(() => {
            ...
            for (let i = 0; i < 2; i++) {
              ...
              const spacingBetweenDefaultPrefabs = 180;
              const spacingBetweenDoubleHitPrefab = 220;
              const ufo = instantiate(randomPrefab);
              this.ufoHitRoot.addChild(ufo);
              ufo.setPosition(targetX, targetY, 0); // 根据预制体类型设置间距
...
//# sourceMappingURL=fb52ffd3b7807bbaa11ba560ea9bbee10dd1e6da.js.map